Import-Module(Join-Path $PSScriptRoot "..\..\..\Modules\cWebAdministration\DSCResources\SEEK_cWebApplication\SEEK_cWebApplication.psm1")

InModuleScope "SEEK_cWebApplication" {
