Import-Module(Join-Path $PSScriptRoot "..\..\..\Modules\cMessageQueue\DSCResources\SEEK_cPrivateMsmqQueuePermissions\SEEK_cPrivateMsmqQueuePermissions.psm1")

InModuleScope "SEEK_cPrivateMsmqQueuePermissions" {
