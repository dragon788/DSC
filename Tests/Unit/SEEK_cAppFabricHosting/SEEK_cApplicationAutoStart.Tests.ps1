...
Import-Module (Join-Path $PSScriptRoot "..\..\..\Modules\cAppFabricHosting\DSCResources\SEEK_cApplicationAutoStart\SEEK_cApplicationAutoStart.psm1")

InModuleScope "SEEK_cApplicationAutoStart" {
