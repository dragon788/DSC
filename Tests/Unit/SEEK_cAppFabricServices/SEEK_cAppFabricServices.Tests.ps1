...
Import-Module (Join-Path $PSScriptRoot "..\..\..\Modules\cAppFabricHosting\DSCResources\SEEK_cAppFabricServices\SEEK_cAppFabricServices.psm1")

InModuleScope "SEEK_cAppFabricServices" {
