Import-Module (Join-Path $PSScriptRoot "..\..\..\Modules\cNServiceBus\DSCResources\SEEK_cNServiceBusHost\SEEK_cNServiceBusHost.psm1")

InModuleScope "SEEK_cNServiceBusHost" {
