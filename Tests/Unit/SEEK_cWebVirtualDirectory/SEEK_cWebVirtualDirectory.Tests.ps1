Import-Module(Join-Path $PSScriptRoot "..\..\..\Modules\cWebAdministration\DSCResources\SEEK_cWebVirtualDirectory\SEEK_cWebVirtualDirectory.psm1")

InModuleScope "SEEK_cWebVirtualDirectory" {
