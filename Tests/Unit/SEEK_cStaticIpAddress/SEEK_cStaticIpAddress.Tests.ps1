Import-Module(Join-Path $PSScriptRoot "..\..\..\Modules\cNetworking\DSCResources\SEEK_cStaticIpAddress\SEEK_cStaticIpAddress.psm1")

InModuleScope "SEEK_cStaticIpAddress" {
